...
import { Bot, Users, Play, X, LogOut, Plus } from 'lucide-react';
    ...
    <div className="min-h-screen bg-slate-950 text-white flex flex-col p-4 md:p-8 relative">
      ...
      <div className="max-w-5xl mx-auto w-full flex-grow flex flex-col mt-12 md:mt-8">
              ...
              >
                {p ? (
                  ...
                  >
                    ...
                    <div className="flex gap-2 mt-1 h-5">
                      {p.isHost && (
        ...
        {isHost ? (
            ...
            <div className="text-center md:text-left flex-1">
              ...
              <p className="text-sm text-slate-400">
                {neededPlayers > 0
                  ...
                  : 'Можно начинать игру, или дождаться больше участников.'}
              </p>
            </div>
          ...
          <div className="bg-slate-900 p-6 rounded-2xl border border-slate-800 shadow-xl text-center flex flex-col items-center justify-center h-28">
            <div className="w-8 h-8 border-4 border-slate-700 border-t-red-500 rounded-full animate-spin mb-3"></div>
            <p className="text-slate-400 font-medium animate-pulse">Ожидание хоста для запуска игры...</p>
          </div>
        )}
      </div>
    </div>
